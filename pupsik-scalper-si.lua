...
local etc = 
    ...
    , asset             = 'SiM7'
    , class             = "SPBFUT"
    , avgFactorSpot     = 1000  -- коэффициент осреднени€ спот
    , avgFactorSigma    = 5000  -- коэфициент осреднени€ волатильности
    , minSpread         = 10    -- расчет: стоимость открыти€ позиции + стоимость закрыти€ позиции + маржа
    , enterSpread       = 0     -- отступ от кра€ стакана дл€ открыти€ позиции
    , openThreshold     = 1.2   -- порог чувствительности дл€ входа в позицию
    , stopLossThreshold = 2     -- порог чувствительности дл€ выхода из позиции
    }
